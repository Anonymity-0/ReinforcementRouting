...
from experiments.run_experiments import train_ppo, evaluate_ppo, run_dijkstra, train_mappo
from visualization.visualize_constellation import visualize_constellation
...
def main():
    ...
    parser.add_argument('--mode', type=str, default='train', 
                      choices=['train', 'eval', 'dijkstra'],
                      help='运行模式: train、eval或dijkstra')
    ...
    save_dir = os.path.join('results', f'{args.algorithm}_{timestamp}')
    ...
    if args.mode == 'train':
        ...
        if args.algorithm == 'ppo':
            ...
            train_mappo(env, save_dir, logger)
        logger.info("训练完成!")
    elif args.mode == 'eval':
        # 评估模式
